...
public class HistoryVotingTestData {
    ...
    public static final HistoryVoting hV1 = new HistoryVoting(HV_ID + 18, LocalDate.now(),REST1, ADMIN);
    public static final HistoryVoting hV2 = new HistoryVoting(HV_ID + 19, LocalDate.now(),REST2, USER_3);
    public static final HistoryVoting hV3 = new HistoryVoting(HV_ID + 20, LocalDate.now(),REST3, ADMIN_4);
    public static final HistoryVoting hV4 = new HistoryVoting(HV_ID + 21, LocalDate.now(),REST3, ADMIN_5);
    public static final HistoryVoting hV5 = new HistoryVoting(HV_ID + 22, LocalDate
            .of(2018, 9,21),REST6, ADMIN);

    public static HistoryVoting getCreated() {
        return new HistoryVoting(null,  LocalDate.now(),REST3, ADMIN);
    }
    public static HistoryVoting getUpdated() { return new HistoryVoting(HV_ID + 1, LocalDate.now(),REST1, ADMIN);}
