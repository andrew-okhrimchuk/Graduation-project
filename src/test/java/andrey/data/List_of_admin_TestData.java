...
public class List_of_admin_TestData {
    ...
    public static final List_of_admin LIST2 = new List_of_admin(2, REST2, ADMIN_2);
    public static final List_of_admin LIST3 = new List_of_admin(3, REST3, ADMIN_2);
    public static final List_of_admin LIST4 = new List_of_admin(4, REST4, ADMIN_2);
